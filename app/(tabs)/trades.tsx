...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 28, fontWeight: '800', color: '#1E293B', paddingHorizontal: 24, paddingTop: 48, paddingBottom: 16 },
  tabContainer: { flexDirection: 'row', paddingHorizontal: 16, marginBottom: 8 },
  tab: { flex: 1, paddingVertical: 12, alignItems: 'center', borderBottomWidth: 2, borderBottomColor: 'transparent' },
  activeTab: { borderBottomColor: '#4ADE80' },
  tabText: { color: '#64748B', fontSize: 16, fontWeight: 'bold' },
  ...
  tradeDetails: { marginBottom: 16 },
  detailText: { color: '#1E293B', fontSize: 14, marginBottom: 8 },
  label: { color: '#64748B' },
  messageText: { color: '#64748B', fontSize: 14, fontStyle: 'italic', marginTop: 8, backgroundColor: '#F8FAFC', padding: 12, borderRadius: 8 },
  actionButtons: { flexDirection: 'row', gap: 12 },
  btn: { flex: 1, paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  acceptBtn: { backgroundColor: '#4ADE80' },
  acceptBtnText: { color: '#000000', fontWeight: 'bold' },
  declineBtn: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#EF4444' },
  declineBtnText: { color: '#EF4444', fontWeight: 'bold' },
  chatBtn: { backgroundColor: 'rgba(14,165,233,0.1)', borderWidth: 1, borderColor: 'rgba(14,165,233,0.3)', borderRadius: 10, paddingVertical: 11, alignItems: 'center' },
  chatBtnText: { color: '#0EA5E9', fontWeight: '700', fontSize: 13 },
  emptyText: { color: '#64748B', textAlign: 'center', marginTop: 40, fontSize: 16 },
  // Admin panel styles
  adminPanel: { backgroundColor: '#F8FAFC', marginHorizontal: 0, borderBottomWidth: 1, borderBottomColor: '#E2E8F0' },
  adminHeader: { paddingHorizontal: 16, paddingTop: 14, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#E2E8F0' },
  adminTitle: { color: '#1E293B', fontSize: 15, fontWeight: '800', letterSpacing: 0.3 },
  adminTabs: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#E2E8F0' },
  adminTab: { flex: 1, paddingVertical: 12, alignItems: 'center' },
  adminTabActive: { borderBottomWidth: 2, borderBottomColor: '#3B82F6' },
  adminTabText: { color: '#64748B', fontWeight: '600', fontSize: 14 },
  adminTabTextActive: { color: '#3B82F6' },
  adminList: { maxHeight: 420 },
  adminCard: { backgroundColor: '#FFFFFF', marginHorizontal: 12, marginVertical: 6, borderRadius: 10, padding: 14, borderWidth: 1, borderColor: '#E2E8F0' },
  adminCardRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  adminCardTitle: { color: '#1E293B', fontWeight: '700', fontSize: 14, flex: 1, marginRight: 8 },
  adminCardSub: { color: '#64748B', fontSize: 12, marginBottom: 12 },
  adminBadge: { paddingHorizontal: 7, paddingVertical: 3, borderRadius: 5 },
  adminBadgeText: { fontSize: 10, fontWeight: '700', color: '#1E293B', textTransform: 'uppercase' },
  adminActions: { flexDirection: 'row', gap: 8 },
  adminBtn: { flex: 1, paddingVertical: 7, borderRadius: 7, alignItems: 'center' },
  adminBtnText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700' },
  adminEmpty: { color: '#64748B', textAlign: 'center', paddingVertical: 20, fontSize: 14 },
